...
#ifndef APSSID
#define APSSID "myLove" // sonfigure visible ssid here
#define APPSK  "" //no need to have password as need to be as free wifi hotspot
#endif
...
void setup() {
  ...
  server.serveStatic("/love1.jpg", SPIFFS, "/love1.jpg");
